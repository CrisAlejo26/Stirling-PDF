    ...
    try {
      ...
      if (result === 'set_successfully') {
        alert({
          ...
          body: t('defaultApp.success.message', 'PDFox is now your default PDF editor'),
        });
        setIsDefault(true);
        ...
        alert({
          ...
          body: t('defaultApp.settingsOpened.message', 'Please select PDFox in the file association dialogue'),
        });
      }
    } catch (error) {
