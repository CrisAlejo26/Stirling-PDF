...
export const SERVER_LICENSE_REQUEST_EVENT = 'pdfox:server-license-requested';
export const UPGRADE_BANNER_TEST_EVENT = 'pdfox:upgrade-banner-test';
export const UPGRADE_BANNER_ALERT_EVENT = 'pdfox:upgrade-banner-alert';
export const START_TOUR_EVENT = 'pdfox:start-tour';
export const TOUR_STATE_EVENT = 'pdfox:tour-state';
